...
.login-area{ width:100%; height:140px; margin:0 auto; background:url(Images/login_02.gif) no-repeat center 0;}
	...
	.login-area input{ width:200px; height:16px; margin-top:11px; border:1px #767F94 solid; font:12px/16px 宋体;}
		input.login-sub{ width:204px; height:34px; border:0; background:url(Images/login_sub.gif) no-repeat 90px 1px; *margin-top:5px;}
		input.login_type{clear:both;width:30px;font:12px/16px 宋体;}
...
<div class="login-area">
	<form action="login.action" method="post">
        ...
        <label>类&nbsp;&nbsp;型：</label><br/>
        <input class="login_type" type="radio" name="type" value="admin" />管理员
        <input class="login_type" type="radio" name="type"  value="employee" />员工
        <input class="login_type" type="radio" name="type" value="guest" checked="checked"/>游客
